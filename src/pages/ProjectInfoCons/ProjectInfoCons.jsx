...
const ProjectInfoCons = () => {
    return (
        <div className="bg-[#d4d4d4] text-black w-full">
            ...
            <div className={'m-10'}>
                <h4 className={'md:text-4xl FontKaisei md:w-1/2 w-full text-2xl'}>This project is a portfolio website for Velez Construcciones, showcasing the company's construction projects and services in a visually appealing and user-friendly manner.</h4>
            ...
            <div className={'md:flex w-full'}>
                ...
                <div className={'md:w-1/5 md:ml-10  md:sticky md:top-20 md:right-0  h-full'}>
                    ...
                    <p className={'md:mt-3 md:m-0 m-10 '}>I developed this website as a freelance project, focusing on creating a modern and responsive design that highlights the company's work. This project allowed me to refine my front-end development skills and implement creative animations.</p>
