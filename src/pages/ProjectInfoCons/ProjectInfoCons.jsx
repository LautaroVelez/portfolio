...
const ProjectInfoCons = () => {
    return (
        <div className="bg-[#d4d4d4] text-black w-full">
            ...
            <div className={'m-10'}>
                <h4 className={'md:text-4xl FontKaisei md:w-1/2 w-full text-2xl'}> A web dedicated to showcasing its portfolio of completed projects and specialized expertise of the construction company. </h4>
